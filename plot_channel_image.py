...
if __name__ == '__main__':
    ...
    parser.add_argument('--base-weights', type=str, default='runs/prune/yolov8s-ASF-P2-Wise-inner-MPDIoU-lamp-exp1.5-prune/weights/model_c2f_v2.pt', help='base weights path')
    parser.add_argument('--prune-weights', type=str, default='runs/prune/yolov8s-ASF-P2-Wise-inner-MPDIoU-lamp-exp1.5-finetune/weights/best.pt', help='prune weights path')
